...
class CBDDQN_Learner(Learner):
    ...
    def update(self, obs_batch, act_batch, rew_batch, next_batch, terminal_batch, belief_distributions):
        self.iterations += 1
        ...
        # 使用信念概率分布计算目标Q值
        belief_distributions = torch.tensor(belief_distributions, device=self.device)
