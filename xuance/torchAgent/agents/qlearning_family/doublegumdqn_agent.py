...
from xuance.torchAgent.agents import Agent
from xuance.torchAgent.learners import *
import torch
...
# from xuance.utils.dummy_vec_env import DummyVecEnv_Gym
# from xuance.utils.buffers import DummyOffPolicyBuffer, DummyOffPolicyBuffer_Atari

class DoubleGum_Agent(Agent):
    def __init__(self,
                 config: Namespace,
        ...
        memory = Buffer(self.observation_space,
                        ...
                        config.buffer_size,
                        config.batch_size)
        learner = DoubleGum_Learner(policy,
                                    optimizer,
                                    scheduler,
                                    config.device,
                                    config.model_dir,
        ...
        super(DoubleGum_Agent, self).__init__(config, envs, policy, memory, learner, device, config.log_dir, config.model_dir)
